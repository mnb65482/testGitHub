...
public enum MemberEditEnum {
    ...
    Creator(1, "创建者", R.color.app_color_blue, 0),
    Manager(4, "取消管理员", R.color.comm_red, 2),
    Member(2, "设为管理员", R.color.common_text_color, 1);
    ...
    MemberEditEnum(int id, String desc, int colorId, int ctrl) {
        this.id = id;
        this.desc = desc;
