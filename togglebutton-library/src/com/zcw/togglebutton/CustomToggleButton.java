...
public class CustomToggleButton extends View{
	...
	/** 关闭颜色*/
	private int offBorderColor = Color.parseColor("#636363");
	/** 灰色带颜色*/
	...
	public void setup(AttributeSet attrs) {
		...
		offBorderColor = typedArray.getColor(R.styleable.CustomToggleButton_tbOffBorderColor, offBorderColor);
		onColor = typedArray.getColor(R.styleable.CustomToggleButton_tbOnColor, onColor);
		spotColor = typedArray.getColor(R.styleable.CustomToggleButton_tbSpotColor, spotColor);
		offColor = typedArray.getColor(R.styleable.CustomToggleButton_tbOffColor, offColor);
		borderWidth = typedArray.getDimensionPixelSize(R.styleable.CustomToggleButton_tbBorderWidth, borderWidth);
		defaultAnimate = typedArray.getBoolean(R.styleable.CustomToggleButton_tbAnimate, defaultAnimate);
		isDefaultOn = typedArray.getBoolean(R.styleable.CustomToggleButton_tbAsDefaultOn, isDefaultOn);
		typedArray.recycle();
